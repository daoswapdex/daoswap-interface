import { ChainId, Currency, currencyEquals, JSBI, Price, WETH, USDT } from '@daoswapdex-bsc-testnet/daoswap-sdk'
  ...
  const tokenPairs: [Currency | undefined, Currency | undefined][] = useMemo(
    () => [
      ...
      [
        ...
        chainId === ChainId.BSC_MAINNET ? USDT[chainId] : undefined
      ],
      [chainId ? WETH[chainId] : undefined, chainId === ChainId.BSC_MAINNET ? USDT[chainId] : undefined]
    ],
