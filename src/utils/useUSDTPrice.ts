import { ChainId, Currency, currencyEquals, JSBI, Price, WETH } from '@daoswapdex-bsc-testnet/daoswap-sdk'
...
export default function useUSDTPrice(currency?: Currency): Price | undefined {
  ...
  const tokenPairs: [Currency | undefined, Currency | undefined][] = useMemo(
    () => [
      ...
      [wrapped?.equals(USDT) ? undefined : wrapped, chainId === ChainId.BSC_MAINNET ? USDT : undefined],
      [chainId ? WETH[chainId] : undefined, chainId === ChainId.BSC_MAINNET ? USDT : undefined]
    ],
