    ...
    <Wrapper showBackground={stakingInfo.openStatus} bgColor={backgroundColor} style={{ display: stakingInfo.display }}>
      ...
      <>
        <BottomSection showBackground={true}>
          <StyledLink
            href={stakingInfo.openStatus ? `https://staking.heco.daoswap.cc/staking/single/${stakingInfo.period}` : ''}
            style={{ width: '100%' }}
          >
        ...
        <BottomSection showBackground={true} style={{ textAlign: 'center', paddingTop: 0 }}>
          <StyledLink
            href={`https://staking.heco.daoswap.cc/staking/single/${stakingInfo.period}/history`}
            style={{ width: '100%' }}
          >
            {t('Stake History')}
          </StyledLink>
